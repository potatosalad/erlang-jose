...
aes_128_gcm_decrypt(CipherText, CipherTag, AAD, IV, CEK) when
    is_bitstring(CipherText) andalso
        ...
        bit_size(CEK) =:= 128
->
    crypto:crypto_one_time_aead(aes_128_gcm, CEK, IV, CipherText, AAD, CipherTag, false).
...
aes_128_gcm_encrypt(PlainText, AAD, IV, CEK) when
    is_bitstring(PlainText) andalso
        ...
        bit_size(CEK) =:= 128
->
    crypto:crypto_one_time_aead(aes_128_gcm, CEK, IV, PlainText, AAD, true).
...
aes_192_gcm_decrypt(CipherText, CipherTag, AAD, IV, CEK) when
    is_bitstring(CipherText) andalso
        ...
        bit_size(CEK) =:= 192
->
    crypto:crypto_one_time_aead(aes_192_gcm, CEK, IV, CipherText, AAD, CipherTag, false).
...
aes_192_gcm_encrypt(PlainText, AAD, IV, CEK) when
    is_bitstring(PlainText) andalso
        ...
        bit_size(CEK) =:= 192
->
    crypto:crypto_one_time_aead(aes_192_gcm, CEK, IV, PlainText, AAD, true).
...
aes_256_gcm_decrypt(CipherText, CipherTag, AAD, IV, CEK) when
    is_bitstring(CipherText) andalso
        ...
        bit_size(CEK) =:= 256
->
    crypto:crypto_one_time_aead(aes_256_gcm, CEK, IV, CipherText, AAD, CipherTag, false).
...
aes_256_gcm_encrypt(PlainText, AAD, IV, CEK) when
    is_bitstring(PlainText) andalso
        ...
        bit_size(CEK) =:= 256
->
    crypto:crypto_one_time_aead(aes_256_gcm, CEK, IV, PlainText, AAD, true).
