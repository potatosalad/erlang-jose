...
-define(TV_CHACHA20_CipherText0(),
    ?b16d(
        "17da83c9c5975af8293701893ee8d258cca06accd5fb9a62d14cdffdb94439f2bb233a1834312fe51e4e8b53d5b625471b31cb80606ed664bafd865880dd51b3"
    )
).
...
support_info() ->
    #{
        ...
        callbacks => [
            {{chacha20_exor, 4}, [
                {jose_chacha20, [{chacha20_stream_init, 3}, {chacha20_stream_exor, 2}, {chacha20_stream_final, 1}]}
            ]},
            {{chacha20_stream_init, 3}, []},
