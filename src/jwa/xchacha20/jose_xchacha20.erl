...
-define(TV_XCHACHA20_CipherText0(), ?b16d("ddb2497cda5966b9fbf8b55ccac692dcd5c42d24d3765bbf55ace2c6fb29f7e013ede084cfb4d8a7f3d74641d8e1c1ad14732eac4ab6ec6b675d207233adba3a")).
...
support_info() ->
	#{
		...
		callbacks => [
			{{xchacha20_exor, 4}, [{jose_hchacha20, [{hchacha20_subkey, 2}]}, {jose_xchacha20, [{xchacha20_stream_init, 3}, {xchacha20_stream_exor, 2}, {xchacha20_stream_final, 1}]}]},
			...
			{{xchacha20_stream_final, 1}, [{jose_hchacha20, [{hchacha20_subkey, 2}]}, {jose_xchacha20, [{xchacha20_stream_init, 3}, {xchacha20_stream_exor, 2}]}]}
		]
	}.
...
support_check(Module, xchacha20_stream_init, 3) ->
	...
	_ = catch Module:xchacha20_stream_final(State),
	ok;
support_check(Module, xchacha20_stream_exor, 2) ->
	...
	_ = catch Module:xchacha20_stream_final(State3),
	?expect([
...
-spec xchacha20_exor(Input, Count, Nonce, Key) -> Output when
	...
	Key :: jose_xchacha20:xchacha20_key(),
	Output :: jose_xchacha20:output().
xchacha20_exor(Input, Count, Nonce, Key)
...
-spec xchacha20_stream_init(Count, Nonce, Key) -> Xchacha20State when
	...
	Key :: jose_xchacha20:xchacha20_key(),
	Xchacha20State :: jose_xchacha20:xchacha20_state().
xchacha20_stream_init(Count, Nonce, Key)
