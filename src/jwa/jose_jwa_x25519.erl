...
-define(A, 486662).
% ?math:intpow(2, 252) + 16#14def9dea2f79cd65812631a5cf5d3ed
-define(order, 7237005577332262213973186563042994240857116359379907606001950938285454250989).
-define(cofactor, 8).
-define(u, 9).
...
-define(a24, 121665).
% (?b + 7) div 8
-define(scalarbytes, 32).
% (?b + 7) div 8
-define(coordinatebytes, 32).
