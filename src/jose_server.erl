...
rsa_ciphertext(rsa_oaep) ->
	<<
                16#AF, 16#A4, 16#46, 16#77, 16#B7, 16#39, 16#3A, 16#AB, 
                16#5A, 16#0C, 16#AB, 16#C2, 16#AD, 16#FA, 16#2C, 16#93, 
                16#1C, 16#A9, 16#59, 16#46, 16#D3, 16#0A, 16#90, 16#7E, 
                16#9B, 16#A0, 16#0D, 16#B4, 16#CF, 16#5C, 16#A6, 16#99, 
                16#C3, 16#71, 16#33, 16#FE, 16#31, 16#12, 16#2C, 16#C2, 
                16#50, 16#4B, 16#85, 16#D7, 16#45, 16#4E, 16#F2, 16#99, 
                16#45, 16#95, 16#C8, 16#BA, 16#6E, 16#66, 16#79, 16#31, 
                16#8E, 16#B7, 16#53, 16#06, 16#20, 16#AC, 16#EB, 16#B6, 
                16#A6, 16#79, 16#9F, 16#F7, 16#5E, 16#89, 16#E1, 16#8A, 
                16#81, 16#60, 16#A7, 16#79, 16#94, 16#54, 16#EF, 16#E7, 
                16#8B, 16#33, 16#7D, 16#1F, 16#E5, 16#AD, 16#1A, 16#66, 
                16#22, 16#90, 16#2A, 16#49, 16#1C, 16#A3, 16#E6, 16#62
	>>;
rsa_ciphertext(rsa_oaep_256) ->
	<<
                16#6F, 16#97, 16#8F, 16#91, 16#73, 16#78, 16#5E, 16#53, 
                16#05, 16#98, 16#D6, 16#C6, 16#11, 16#38, 16#5D, 16#C6, 
                16#9B, 16#C6, 16#92, 16#DE, 16#B2, 16#F9, 16#5F, 16#CB, 
                16#23, 16#29, 16#93, 16#1B, 16#6D, 16#7E, 16#38, 16#43, 
                16#5B, 16#7F, 16#52, 16#AF, 16#18, 16#E2, 16#F7, 16#66, 
                16#E0, 16#9C, 16#5F, 16#40, 16#74, 16#5D, 16#BB, 16#5B, 
                16#9C, 16#DD, 16#98, 16#92, 16#55, 16#CB, 16#D1, 16#1C, 
                16#E0, 16#A1, 16#1F, 16#1F, 16#FC, 16#6E, 16#3D, 16#CC, 
                16#59, 16#14, 16#3B, 16#C1, 16#1D, 16#77, 16#07, 16#1A, 
                16#58, 16#36, 16#BC, 16#FE, 16#62, 16#83, 16#B9, 16#43, 
                16#71, 16#AC, 16#DE, 16#6A, 16#C6, 16#80, 16#3E, 16#E3, 
                16#00, 16#75, 16#B5, 16#C3, 16#49, 16#FC, 16#D3, 16#0F
	>>.
