...
key_decrypt(
    {UStaticPublicKey = #jose_jwk{}, VStaticSecretKey = #jose_jwk{}, UEphemeralKey = #jose_jwk{}},
    EncryptedKey,
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{epk = UEphemeralPublicKey = #jose_jwk{}}
) ->
...
key_decrypt(
    {UStaticPublicKey = #jose_jwk{}, VStaticSecretKey = #jose_jwk{}, UEphemeralPublicKey = #jose_jwk{}},
    EncryptedKey,
    JWEECDH1PU0 = #jose_jwe_alg_ecdh_1pu{epk = undefined}
) ->
    JWEECDH1PU = JWEECDH1PU0#jose_jwe_alg_ecdh_1pu{epk = UEphemeralPublicKey},
    key_decrypt({UStaticPublicKey, VStaticSecretKey}, EncryptedKey, JWEECDH1PU);
key_decrypt(
    {UStaticPublicKey = #jose_jwk{}, VStaticSecretKey = #jose_jwk{}},
    EncryptedKey,
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{epk = UEphemeralPublicKey = #jose_jwk{}}
) ->
...
key_decrypt(Z, {ENCModule, ENC, <<>>}, #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = undefined, bits = undefined}) when
    is_binary(Z)
->
...
key_decrypt(
    ...
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = aes_gcm_kw, bits = KeyDataLen, iv = IV, tag = TAG}
) when
    is_binary(Z) andalso
...
key_decrypt(
    Z, {_ENCModule, _ENC, EncryptedKey}, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = aes_kw, bits = KeyDataLen}
) when is_binary(Z) ->
    Algorithm = algorithm(JWEECDH1PU),
    SuppPubInfo = <<KeyDataLen:1/unsigned-big-integer-unit:32>>,
    DerivedKey = jose_jwa_concat_kdf:kdf(sha256, Z, {Algorithm, APU, APV, SuppPubInfo}, KeyDataLen),
...
key_decrypt(
    Z,
    {_ENCModule, _ENC, EncryptedKey},
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = c20p_kw, bits = KeyDataLen, iv = IV, tag = TAG}
) when
    is_binary(Z) andalso
        is_binary(IV) andalso
        is_binary(TAG)
...
key_decrypt(
    Z,
    {_ENCModule, _ENC, EncryptedKey},
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = xc20p_kw, bits = KeyDataLen, iv = IV, tag = TAG}
) when
    is_binary(Z) andalso
        is_binary(IV) andalso
        is_binary(TAG)
...
key_encrypt(_Key, _DecryptedKey, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{wrap = undefined, bits = undefined}) ->
    {<<>>, JWEECDH1PU};
key_encrypt(
    {VStaticPublicKey = #jose_jwk{}, UStaticSecretKey = #jose_jwk{}, UEphemeralSecretKey = #jose_jwk{}},
    DecryptedKey,
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{epk = UEphemeralPublicKey = #jose_jwk{}}
) ->
...
key_encrypt(
    {VStaticPublicKey = #jose_jwk{}, UStaticSecretKey = #jose_jwk{}, UEphemeralSecretKey = #jose_jwk{}},
    DecryptedKey,
    JWEECDH1PU0 = #jose_jwe_alg_ecdh_1pu{wrap = undefined, bits = undefined, epk = undefined}
) ->
...
key_encrypt(
    Z, DecryptedKey, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = aes_gcm_kw, bits = KeyDataLen, iv = IV}
) when
    is_binary(Z) andalso
        is_binary(IV)
->
...
key_encrypt(Z, DecryptedKey, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = aes_kw, bits = KeyDataLen}) when
    is_binary(Z)
->
    Algorithm = algorithm(JWEECDH1PU),
    SuppPubInfo = <<KeyDataLen:1/unsigned-big-integer-unit:32>>,
...
key_encrypt(
    Z, DecryptedKey, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = c20p_kw, bits = KeyDataLen, iv = IV}
) when
    is_binary(Z) andalso
        is_binary(IV)
->
    ...
    {CipherText, JWEECDH1PU#jose_jwe_alg_ecdh_1pu{tag = CipherTag}};
key_encrypt(
    Z, DecryptedKey, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = xc20p_kw, bits = KeyDataLen, iv = IV}
) when
    is_binary(Z) andalso
        is_binary(IV)
->
...
next_cek(
    {VStaticPublicKey = #jose_jwk{}, UStaticSecretKey = #jose_jwk{}, UEphemeralSecretKey = #jose_jwk{}},
    {ENCModule, ENC},
    JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{bits = undefined, epk = UEphemeralPublicKey = #jose_jwk{}}
) ->
    case jose_jwk:thumbprint(UEphemeralSecretKey) =:= jose_jwk:thumbprint(UEphemeralPublicKey) of
        true ->
            Ze = jose_jwk:shared_secret(VStaticPublicKey, UEphemeralSecretKey),
...
next_cek(
    #jose_jwk{kty = {KTYModule, KTY}}, {ENC, ENCModule}, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{wrap = undefined, bits = undefined}
) ->
    DerivedKey = KTYModule:derive_key(KTY),
    next_cek(DerivedKey, {ENCModule, ENC}, JWEECDH1PU);
next_cek(Z, {ENCModule, ENC}, JWEECDH1PU = #jose_jwe_alg_ecdh_1pu{apu = APU, apv = APV, wrap = undefined, bits = undefined}) when
    is_binary(Z)
->
    Algorithm = ENCModule:algorithm(ENC),
    KeyDataLen = ENCModule:key_bit_size(ENC),
