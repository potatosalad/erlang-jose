...
rsaes_oaep_encryptor_gen() ->
    ?LET(
        {DigestType, ModulusSize, PlainText},
        ?SUCHTHAT(
            {DigestType, ModulusSize, PlainText},
...
prop_rsaes_oaep_encrypt_and_decrypt() ->
    ?FORALL(
        {{PrivateKey, PublicKey}, _ModulusSize, DigestType, PlainText},
        rsaes_oaep_encryptor_gen(),
        begin
...
prop_rsaes_oaep_encrypt_and_decrypt_with_label() ->
    ?FORALL(
        {{PrivateKey, PublicKey}, _ModulusSize, DigestType, Label, PlainText},
        rsaes_oaep_encryptor_with_label_gen(),
        begin
...
prop_rsaes_pkcs1_encrypt_and_decrypt() ->
    ?FORALL(
        {{PrivateKey, PublicKey}, _ModulusSize, PlainText},
        rsaes_pkcs1_encryptor_gen(),
        begin
...
prop_rsassa_pkcs1_sign_and_verify() ->
    ?FORALL(
        {{PrivateKey, PublicKey}, _, DigestType, Message},
        rsassa_pkcs1_signer_gen(),
        begin
...
rsassa_pss_signer_with_salt_gen() ->
    ?LET(
        {DigestType, ModulusSize, SaltSize},
        ?SUCHTHAT(
            {DigestType, ModulusSize, SaltSize},
...
prop_rsassa_pss_sign_and_verify_with_salt() ->
    ?FORALL(
        {{PrivateKey, PublicKey}, _ModulusSize, DigestType, Salt, Message},
        rsassa_pss_signer_with_salt_gen(),
        begin
